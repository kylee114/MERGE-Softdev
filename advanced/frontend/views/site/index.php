...
.bg-gradient {
  overflow: hidden;
  color: #212529;
  background: linear-gradient(-30deg, #b0b0b0 0%, #cdcdcd 50%, #cdcdcd 100%); }
...
.filter-gradient {
  ...
  .filter-gradient:before {
    ...
    height: 100%;
    content: ' ';
    background: linear-gradient(-30deg, rgba(176, 176, 176, 0.9) 0%, rgba(205, 205, 205, 0.9) 50%, rgba(205, 205, 205, 0.95) 100%); }
    ...
    <div class="container">
      <div class="row">
        <div class="mx-auto text-center col-md-6">
          <h1 class="display-1 text-white">AfterLife</h1>
          <p class="lead text-primary">Lead paragraph -&nbsp;Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
        </div>
      </div>
    </div>
  </div>
